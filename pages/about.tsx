		...
		<>
			...
			<Layout preview={preview}>
				...
				<Container>
					<br />
					<img
						src={'https://res.cloudinary.com/yongstal/image/upload/v1614658682/portfolio/SAM_3421_kmvghe.jpg'}
						alt={`${CLIENT_NAME}'s cover image`}
						className={'w-50vw'}
					/>

					<h2 className='hover:text-tailwindBlue text-black text-6xl md:text-3xl font-bold tracking-tight md:tracking-tighter leading-tight mb-20 mt-8'>
						<Link href='/about'>
							<a className='hover:text-tailwindBlue text-black'>{ `Hello, my name is ${CLIENT_NAME}!`}</a>
						</Link>
